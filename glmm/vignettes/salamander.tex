...
This vignette demonstrates how to format the data in Section \ref{sec:format}, fit the model in Section \ref{sec:fitmod}, access the model summary in Section \ref{sec:summary}, extract fixed effect estimates and variance estimates in Section \ref{sec:coefs}, calculate confidence intervals in Section \ref{sec:ci},  and access additional output in Section \ref{sec:otherstuff}. 
...
+ 0.9723 * I(Cross=W/W) + u_i^F+u_i^M\\
